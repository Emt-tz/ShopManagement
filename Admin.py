...
class Admin(tk.Tk):
	...
	def Mainmenu(self):
		...
		btns = Button(self.centerframe,text="Shop".upper(),height=5,width=20,command=self.shop,bg=self.color[0])
		btns.place(relx=0.55,rely=0.15)


		btns1 = Button(self.centerframe,text="Analysis".upper(),height=5,width=20,command=self.analyse,bg=self.color[0])
		btns1.place(relx=0.15,rely=0.15)

		btns2 = Button(self.centerframe,text="mobile money".upper(),height=5,width=20,command=self.mobile,bg=self.color[0])
		btns2.place(relx=0.15,rely=0.4)

		btns4 = Button(self.centerframe,text="Receipt".upper(),height=5,width=20,command=self.receipt,bg=self.color[0])
		btns4.place(relx=0.55,rely=0.4)

		btns3 = Button(self.centerframe,text="Product Manegement".upper(),height=5,width=20,command=self.prodmgmt,bg=self.color[0])
		btns3.place(relx=0.15,rely=0.65)

		btns5 = Button(self.centerframe,text="Exit".upper(),height=5,width=20,command=self.exit,bg=self.color[0])
