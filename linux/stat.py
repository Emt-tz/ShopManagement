...
class Admin(tk.Tk):
	...
	def Mainmenu(self):
		...
		btns = Button(self.centerframe,font='time 8',text="Shop".upper(),height=5,width=22,command=self.shop,bg=self.color[0])
		btns.place(relx=0.55,rely=0.15)


		btns1 = Button(self.centerframe,font='time 8',text="Analysis".upper(),height=5,width=22,command=self.analyse,bg=self.color[0])
		btns1.place(relx=0.15,rely=0.15)

		btns2 = Button(self.centerframe,font='time 8',text="Dashboard".upper(),height=5,width=22,command=self.dash,bg=self.color[0])
		btns2.place(relx=0.15,rely=0.65)

		btns4 = Button(self.centerframe,font='time 8',text="Receipt".upper(),height=5,width=22,command=self.receipt,bg=self.color[0])
		btns4.place(relx=0.55,rely=0.4)

		btns3 = Button(self.centerframe,font='time 8',text="Product Manegement".upper(),height=5,width=22,command=self.prodmgmt,bg=self.color[0])
		btns3.place(relx=0.15,rely=0.4)

		btns5 = Button(self.centerframe,font='time 8',text="Exit".upper(),height=5,width=22,command=self.exit,bg=self.color[0])
		btns5.place(relx=0.55,rely=0.65)

		btns22 = Button(self.centerframe,font='time 8',text="Help".upper(),height=1,width=6,command=self.mobile,bg=self.color[3])
		btns22.place(relx=0.78,rely=0.84)

		heading = Label(self.mainframe,font='time 8 bold',fg='red',text="Please adjust clock for the data to be correct".upper())
