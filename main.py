...
include_files = ["tcl86t.dll", "tk86t.dll","sales"]
packages = ["tkinter","datetime","time","sqlite3"]
...
setup(name="Shop",options=options,version="0.1",description="<any description>",executables=executables)